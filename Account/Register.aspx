...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <asp:Label runat="server" AssociatedControlID="" CssClass="col-md-2 control-label">Name</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="txtName" CssClass="form-control" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="mobile"
                    CssClass="text-danger" ErrorMessage="The Name is Required." />
            </div>
            <asp:Label runat="server" AssociatedControlID="" CssClass="col-md-2 control-label">Mobile</asp:Label>
            <div class="col-md-10">
